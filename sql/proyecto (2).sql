...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-10-2018 a las 21:19:08
...
INSERT INTO `grupos` (`id_grupo`, `nombre_proyecto`, `n1`, `n2`, `n3`, `n4`, `n5`, `id_juez`) VALUES
(1, 'robot', 'a', 'f', 'd', 'v', 's', 22);
...
INSERT INTO `jueces` (`id_juez`, `nombre_juez`, `id_categoria`) VALUES
(22, 'yancy', 1),
(23, '', 0),
(24, '', 0),
(25, '', 0),
...
--
ALTER TABLE `jueces`
  MODIFY `id_juez` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
--

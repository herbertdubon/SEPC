			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li>
								<a href="#subPages" class="active" data-toggle="collapse" class="collapsed"><i class="fas fa-clipboard-check"></i> <span>Evaluacion Grupos</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
				...
				<div class="well form-horizontal">
					<fieldset>
						...
						<div class="form-group">
							<a><label class="col-md-4 control-label">Nombre Completo</label></a>  
							<div class="col-md-4 inputGroupContainer">
								<div class="input-group">
									<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
									<input id="nombre" name="njurado" placeholder="Ingresar Nombre..." class="form-control"  type="text">
								</div>
							</div>
						</div>
						...
						<!-- Text input-->
						<div class="form-group">
							<a><label class="col-md-4 control-label">Numero de Categoria</label></a>
							<div class="col-md-4 inputGroupContainer">
								<div class="input-group">
									<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
									<input id="catnum" name="ncategoria" placeholder="Ingresar # de Categoria" class="form-control"  type="text">
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-4" align="center">
								<button id="registrarNuevo" type="submit" class="btn btn-primary btn-lg" >Enviar<span class="glyphicon glyphicon-send"></span></button>
							</div>
						</div>

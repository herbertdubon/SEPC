<?Php
    ...
    $stmt=$dbcon->prepare("SELECT * FROM grupos where total_cat3>0 and categoria='Metodologia de la Investigacion' ORDER BY total_cat3 DESC;");
    $stmt->execute();
    $json= [];
    $json2= [];
    $json3= [];
...
<div class="col l2 m4 s6">
    <ul>
        <li>
            <h1>Resultados de Póster Científico</h1>
